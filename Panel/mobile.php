...
$result=mysqli_query($link,"update mobile set mobile= $mobile");

if($result){
     echo "<script>alert('تم تغيير رقم الواتساب بنجاح'); 
        	      </script>";
}
    }
...
<section class="page-content">
  ...
  <section class="grid">
    <div class="box">
        ...
        <h2>تغيير رقم الواتساب</h2>
        
        <form method="post">
            
            
            <div  dir="rtl"class="inputBox">
             <span  id="ccode"></span>
