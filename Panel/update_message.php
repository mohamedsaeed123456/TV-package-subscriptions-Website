...
$color=$_POST['color'];
$result=mysqli_query($link,"update message set msg='$msg' , background_color='$background_color' , color='$color' ");

if($result){
     echo "<script>alert('تم تغيير الرسالة الموجودة اعلي الصفحة الرئيسية بنجاح'); 
        	      </script>";
}
    }
...
$result=mysqli_query($link,"Select * from message");
        ...
        <h2>تغيير الرسالة الموجودة اعلي الصفحة الرئيسية</h2>
        
        <form method="POST">
            <div class="inputBox">
             <input type="title" id="msg" value="<?php echo $row['msg'] ?>" name="msg" required="">
             <label>الرسالة</label>
            </div>
            <div class="inputBox">
             <input type="color" id="background_color" value="<?php echo $row['background_color'] ?>" name="background_color" required="">
             <label>كود لون الخلفية</label>
            </div>
            <div class="inputBox">
             <input type="color" id="color" value="<?php echo $row['color'] ?>" name="color" required="">
             <label>كود لون الخط</label>
            </div>
