...
<header class="page-header">
  <nav>
    ...
    <ul class="admin-menu">
      ...
      <li>
       ...
       <li class="menu-heading">
        ...
        <a href="display_device.php">
          ...
          <span>استعراض اجهزة الضمان</span>
        </a>
      </li>
      <li class="menu-heading">
      ...
      <li>
        <a href="https://unwashed-blast.000webhostapp.com/share/">
          <svg>
            <use xlink:href="#settings"></use>
          </svg>
...
<main class="st_viewport">
  <div class="st_wrap_table" data-table_id="0">
    <header class="st_table_header">
      <div class="st_row">
        <div class="st_column _rank">اسم العميل</div>
        <div class="st_column _name">رقم هاتف العميل</div>
				<div class="st_column _name">اسم الجهاز</div>
        <div class="st_column _surname">رقم الجهاز (سريال)</div>
        <div class="st_column _year">تاريخ شراء المنتج</div>
				 <div class="st_column _year">تاريخ انتهاء ضمان الجهاز</div>
    ...
    <div class="st_table">
        ...
        $result=mysqli_query($link,"Select * from add_device");
        while($row = mysqli_fetch_array($result)){
        ?>
      <div class="st_row">
        <div class="st_column _rank"><?php echo $row['name']; ?></div>
        <div class="st_column _name"><?php echo $row['mobile']; ?></div>
				<div class="st_column _surname"><?php echo $row['name1']; ?></div>
        <div class="st_column _surname"><?php echo $row['serial']; ?></div>
        <div class="st_column _year"><?php echo $row['start']; ?></div>
         <div class="st_column _year"><?php echo $row['finish']; ?></div>
        <div class="st_column _section">
        <a href="edit_device.php?GETID=<?php echo $row['id']; ?> "> <button class="glow-on-hover" type="button">تعديل</button></a>
      <a href="delete_device.php?Del=<?php echo $row['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button> </a>
        </div>
      </div>
    <?php } ?>
