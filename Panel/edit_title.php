<?php 
  ...
  $query="select * from title_share where id= '".$id."'";
...
<section class="page-content">
  ...
  <section class="grid">
        ...
        <h2>تعديل عناويين الاشتراكات</h2>
        
        <form method="POST" action="update1.php?Id=<?php echo $id1 ?>">
            <div class="inputBox">
             <input type="title" id="title" value="<?php echo $title ?>" name="title" required="">
