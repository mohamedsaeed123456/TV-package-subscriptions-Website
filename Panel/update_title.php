...
<main class="st_viewport">
  <div class="st_wrap_table" data-table_id="0">
    ...
    <div class="st_table">
        ...
        ?>
      <div class="st_row">
        <div class="st_column _rank"><?php echo $row['title']; ?></div>
      
        <div class="st_column _section">
         <a href="edit_title.php?GetId=<?php echo $row['id'];?>">   <button class="glow-on-hover" type="button">تعديل</button></a>
      <a href="delete1.php?DEL=<?php echo $row['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button>
</a>
        </div>
      </div>
    <?php } ?>
