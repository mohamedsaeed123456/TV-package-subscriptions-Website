...
include 'connection.php';
   ...
   $serial=stripcslashes($_POST['serial']);
	 ...
	 $finish=stripcslashes($_POST['finish']);
	$result = mysqli_query($link,"insert into add_device (name,mobile,name1,serial,start,finish) values ('$name','$mobile', '$name1','$serial','$start','$finish')");
         
          if($result){
        	      echo "<script>alert(' تم اضافة ضمان الجهاز بنجاح ')</script>";
          }
         else{
        	      echo "<script>alert('حدث خطأ ما اثناء اضافة ضمان الجهاز')</script>";
          }
        }
  ...
  <section class="grid">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="inputBox" >
						  ...
						  <input type="password"id="password" name="serial" required="">
