...
include 'connection.php';
   ...
   $title1=stripcslashes($_POST['title1']);
	$result = mysqli_query($link,"insert into add_share (title1,description,price,image) values ('$title1','$description', '$price','$image')");
         
          if($result){
        	      echo "<script>alert(' تم اضافة الاشتراك بنجاح')</script>";
          }
         else{
        	      echo "<script>alert('حدث خطأ ما اثناء اضافة الاشتراك')</script>";
          }
        }
...
<section class="page-content">
  ...
  <section class="grid">
        ...
        <h2>اضافة الاشتراك</h2>
        
        <form method="post" enctype="multipart/form-data">
           
            <div class="inputBox">
         
               <select style="background-color:#242e42;" dir="rtl" name="title1" id="type">
                     
                  <option value="0">----</option>
                         <?php 
include 'connection.php';
$result=mysqli_query($link,"Select * from title_share");
            ...
            <div class="inputBox" >
                <input type="text"id="number" name="price" required="">
                <label>سعر الاشتراك</label>
            </div>
             <div class="inputBox" >
                <input dir="rtl" type="file"id="image" name="image" required="">
