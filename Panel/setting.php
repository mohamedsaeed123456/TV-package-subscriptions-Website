...
$result=mysqli_query($link,"update login set username='$username' , password='$password',name='$name' ,image='$image' ");

if($result){
     echo "<script>alert('تم تحديث بيانات لوحة التحكم بنجاح'); 
        	      </script>";
}
    }
...
<section class="page-content">
  ...
  <section class="grid">
     ...
     <div class="box">
        ...
        <h2>تحديث بيانات لوحة التحكم</h2>
...
$result=mysqli_query($link,"Select * from login");
            ...
            <div class="inputBox">
             ...
             <input type="text" id="text" name="username" value="<?php echo $row['username']; ?>"  required="">
             ...
             <div class="inputBox" >
                ...
                <input  type="text"id="text" name="name" value="<?php echo $row['name']; ?>" required="">
                <label>اسم الموقع</label>
                
            </div>
             <div class="inputBox" dir="rtl">
