<?php 
  ...
  $query="select * from add_share where id= '".$id."'";
...
<section class="page-content">
  ...
  <section class="grid">
        ...
        <form method="post" action="update.php?ID=<?php echo $id1 ?>" enctype="multipart/form-data">
...
$result=mysqli_query($link,"Select * from title_share");
            ...
            <div class="inputBox" >
                <input type="text"id="number" value="<?php echo $price ?>" name="price" required="">
                <label>سعر الاشتراك</label>
            </div>
             <div class="inputBox" >
                <input dir="rtl" type="file"id="image" value="" name="image">
