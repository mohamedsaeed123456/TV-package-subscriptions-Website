...
<main class="st_viewport">
  <div class="st_wrap_table" data-table_id="0">
    <header class="st_table_header">
      <div class="st_row">
        <div class="st_column _rank">عنوان الاشتراك</div>
        <div class="st_column _name">وصف الاشتراك</div>
        <div class="st_column _surname">سعر الاشتراك</div>
        <div class="st_column _year">صورة الااشتراك</div>
    ...
    <div class="st_table">
        ...
        ?>
      <div class="st_row">
        <div class="st_column _rank"><?php echo $row['title1']; ?></div>
        <div class="st_column _name"><?php echo $row['description']; ?></div>
        <div class="st_column _surname"><?php echo $row['price']; ?></div>
        <div class="st_column _year">      <?php echo '<img width="50" height="50" class="lazyloaded" src="data:image;base64 ,'.$row['image'].'" >';?>
</div>
        <div class="st_column _section">
        <a href="edit_share.php?GETID=<?php echo $row['id']; ?> "> <button class="glow-on-hover" type="button">تعديل</button></a>
      <a href="delete.php?Del=<?php echo $row['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button> </a>
        </div>
      </div>
    <?php } ?>
