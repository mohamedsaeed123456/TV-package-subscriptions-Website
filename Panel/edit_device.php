<?php 
  ...
  $query="select * from add_device where id= '".$id."'";
...
.box .inputBox1 input:focus ~ label,
.box .inputBox1 input:valid ~ label{
    top: -18px;
    left: 0;
    color: #03a9f4;
    font-size: 12px;    
...
<section class="page-content">
  ...
  <section class="grid">
        ...
        <h2>تحديث بيانات ضمان الجهاز</h2>
        
        <form method="post" action="update_device.php?ID=<?php echo $id1 ?>" enctype="multipart/form-data">
            ...
            <div class="inputBox">
             ...
             <label>رقم هاتف العميل</label>
						...
						<div class="inputBox">
             <input type="text" id="name1" name="name1" value="<?php echo $name1 ?>" required="">
             <label>اسم الجهاز</label>
            </div>
            <div class="inputBox" >
								 <i class="bi bi-eye-slash" id="togglePassword"></i> 
						  <input type="password"id="password" name="serial" value="<?php echo $serial ?>" required="">
                <label>رقم الجهاز (سريال)</label>
            </div>
						
             <div class="inputBox1" >
                <input  type="date"id="start" name="start" value="<?php echo $start ?>" required="">
                <label>تاريخ شراء المنتج</label>
            </div>
						 <div  class="inputBox1">
                <input  type="date"id="finish" name="finish" value="<?php echo $finish ?>" required="">
                <label>تاريخ انتهاء ضمان الجهاز</label>
            </div>
